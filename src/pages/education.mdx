...
import image1 from '../assets/Education/image/image1.jpg';
import image2 from '../assets/Education/image/image2.JPG';
import image3 from '../assets/Education/image/image3.JPG';
import image4 from '../assets/Education/image/image4.jpg';
import image5 from '../assets/Education/image/image5.jpg';
import image6 from '../assets/Education/image/image6.jpg';
import image7 from '../assets/Education/image/image7.jpg';
import image8 from '../assets/Education/image/image8.jpg';
import image9 from '../assets/Education/image/image9.jpg';
import image10 from '../assets/Education/image/image10.jpg';
import image11 from '../assets/Education/image/image11.JPG';
import image12 from '../assets/Education/image/image12.jpg';
import image13 from '../assets/Education/image/image13.jpg';
import image14 from '../assets/Education/image/image14.jpg';
import image15 from '../assets/Education/image/image15.jpg';
import image16 from '../assets/Education/image/image16.JPG';
import image17 from '../assets/Education/image/image17.jpeg';
import image18 from '../assets/Education/image/image18.jpg';
...
(japanese):[実験を成功させろ！カードゲーム.pdf](/docs/Education/PDF/0602実験教室プロトコル.pdf)  
(english): [Make the Experiment a Success! Card Game.pdf](/docs/Education/PDF/0602実験教室プロトコル.pdf)
...
Protocol: (Japanese)
[2024/6/2実験教室 プロトコル.docx](/docs/Education/PDF/0602実験教室プロトコル.pdf)  
Protocol: (Enlish)
[Experiment Classroom Protocol for June 2, 2024.docx](/docs/Education/PDF/0602実験教室プロトコル.pdf)  
Slides: (Japanese)  
[iGEM 実験教室 0602.pdf](/docs/Education/PDF/0602実験教室プロトコル.pdf)  
Handout: (Japanese)  
[iGEM 0602 事前時配布資料.pdf](public/docs/Education/PDF/iGEM 0602 事前時配布資料.pdf)
...
Protocol: (Japanese)  
[8/4プロトコル(当日配布資料)](/docs/Education/PDF/8_4_Experimental_class_handouts_jp_ver.pdf)  
Protocol: (English)  
[8/4 Experimental class handouts English ver.](/docs/Education/PDF/8_4_Experimental_class_handouts_English_ver.pdf)  
Slides: (Japanese)  
[iGEM 実験教室 0804.pdf](/docs/Education/PDF/iGEM%20実験教室%200804.pdf)
...
Slides (Japanese):  
[iGEM Grand Tokyo Shizuoka Lecture.pdf](/docs/Education/PDF/iGEM%20Grand%20Tokyo%20Shizuoka%20Lecture%20(1).pdf)  
[Post-Seminar Survey for Grand Tokyo Seminar on July 23_Responses](/docs/Education/PDF/7_23_アンケート.pdf)
...
Slides: (English)  
 [iGEM Grand Tokyo Hiroo Lecture](/docs/Education/PDF/iGEM_Grand_Tokyo_Hiroo_Lecture.pdf)
...
Slides: (japanese)  
[生物の研究について　iGEM Grand Tokyo.pdf](/docs/Education/PDF/生物の研究について.pdf)
...
![][image2]  
Weekly iGEM: (english)  
[Weekly iGEM wiki.pdf](/docs/Education/PDF/Weekly_iGEM_wiki_English_ver.pdf)
...
[Education Article](/docs/Education/PDF/EducationArticle_all.pdf)
...
Examples of posts  
[(Japanese)iGEM Grand Tokyo instagram post.PNG](public/docs/Education/images/iGEM_Grand_Tokyo_Japanese_ver_instagram_post.PNG)  
[(Enlish)iGEM Grand Tokyo instagram post.PNG](public/docs/Education/images/iGEM_Grand_Tokyo_English_ver_instagram_post.PNG)
...
Slides (japanese)  
 [Eggfoward様用中間報告.pdf](public/docs/Education/PDF/Eggfoward様用中間報告.pdf)
...
[輪読会資料①.pdf](public/docs/Education/PDF/輪読会資料①.pdf)

[2024613輪読会.pdf](public/docs/Education/PDF/2024613輪読会.pdf)

[Software.pdf](public/docs/Education/PDF/Software.pdf)
